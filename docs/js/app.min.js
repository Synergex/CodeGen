...
f.first().trigger("focus")):(d.preventDefault(),f.last().trigger("focus"))))}break;case 32:d.preventDefault(),$("#hs-popup-wrap .hs-popup-links").find("li > a:focus").trigger("click")}}).on("mousedown",function(d){if("hs-search-panel"==a.getActiveTabId()){var f=$("#sorting-popup-menu:visible");f.length&&!$(d.target).closest(f).length&&a.hideSortingPopupMenu()}});a.initSearch();a.topicLoaded();a.eventDispatcher.dispatchEvent("topicLoaded");a.procSearchRequest()})};
...
autoCollapse:b.options.tocTreeAutoCollapse,noButtons:b.options.tocTreeNoButtons,noIcons:b.options.tocTreeNoIcons,data:e,onActivate:function(d){b.tocScrollDisabledOnLoad=!0;var f=b.$tocTree.hsTree("getNodeTarget",d);f&&b.goTreeNaviLink(f.href,f.target,function(){b.scrollToSelTocNode(d,!1)})},onClick:function(d,f){if(d.ctrlKey&&(d=b.$tocTree.hsTree("getNodeTarget",f))&&"#"!=d.href)return b.goLink(d.href,"",!0),!0},onCreateNode:function(d,f){!b.$tocTree.noIcons&&f.icon&&d.addClass(f.icon)}})})(a);b.$tocTree.addClass(b.options.tocTreeCls);
!b.options.tocTreeAutoCollapse&&0<=b.options.tocExpandOnStartup&&b.$tocTree.hsTree("expandAll",b.options.tocExpandOnStartup);(a=b.selectTopicByURL(location.href))&&b.scrollToSelTocNode(a);b.followAnchor();b.$tocTree.addClass("hs-ani")};
